            ...
            echo "<tr>
               ...
               while($row = mysqli_fetch_assoc($select_post_id_query)){
                ...
                echo "<td>$comment_date</td>
                    ...
                    <td><a href='post_comments.php?unapprove=$comment_id&id=".$_GET['id']."'>Unaprove</a></td>
                    <td><a onClick=\" javascript: return confirm('Are you sure you want to delete'); \" href='post_comments.php?delete=$comment_id&id=".$_GET['id']."'>Delete</a></td>
