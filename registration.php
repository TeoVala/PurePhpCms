    ...
    <div class="container">
        ...
        <form method="get" class="navbar-form navbar-right"  id="language_form" action="">
            <div class="form-group">
                <select onchange="change_language()" name="lang">
                    <option value="en"
                    ...
                    <option value="gr"
                        <?php if (isset($_SESSION['lang']) && $_SESSION['lang'] == 'gr') {
                            echo "selected";
                        }
                        ?>
                        >Ελληνικά</option>
            ...
            <div class="col-xs-6 col-xs-offset-3">
                ...
                <h1><?php echo _REGISTER; ?></h1>
                    <form role="form" action="registration.php" method="post" id="login-form" autocomplete="off">
                        ...
                        <input type="submit" name="register" id="btn-login" class="btn btn-custom btn-lg btn-block" value="<?php echo "Register"; ?>">
                    </form>
